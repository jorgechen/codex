...
module.exports = {
  config: {
    ...
    fontFamily: 'Fira Code, Operator Mono, Menlo, "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',
    ...
    selectionColor: 'white', // setting `white` is a temporary solution until they fix the drop shadow https://github.com/vercel/hyper/issues/4466
